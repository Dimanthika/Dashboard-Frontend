...
import { create } from "../../services/electorate";
    ...
    if (validator.current.allValid()) {
      try {
        ...
        const response = await create({
          ...
          name: name,
          currentVoters: 0,
          electorateDistrict: props.district,
          isActive: true,
  ...
  return (
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Create polling division</DialogTitle>
          <DialogDescription>
            Make changes to polling division here. Click save when you're done.
          </DialogDescription>
        </DialogHeader>
